...
class XGBoostTree:
    ...
    def hist_fit(self, histogram, max_bins, subsample_cols=0.8, min_leaf=5, min_child_weight=1, depth=10, lambda_=1, gamma=1):
        feature_splits = histogram.feature_splits
        self.dtree = HistogramNode(histogram.histogram, feature_splits, subsample_cols=0.8, min_leaf=5, min_child_weight=1,
                 depth=10, lambda_=1, gamma=1)
        return self
